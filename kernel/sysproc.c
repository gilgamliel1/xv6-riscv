...
uint64 sys_exit(void)
{
  ...
  argint(0, &n);
  argstr(1, exit_msg, 32);  // ✅ correct usage

  exit(n, exit_msg);  // pass buffer to exit()
  return 0;
}
...
extern int peterson_acquire(int, int);
extern int peterson_release(int, int);
extern int peterson_destroy(int);
